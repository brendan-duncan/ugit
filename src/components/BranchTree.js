...
function TreeNode({ node, currentBranch, branchStatus, level = 0 }) {
  ...
  return (
    <div className="tree-node">
      <div
        className={`tree-node-content ${isCurrent ? 'current' : ''}`}
...
function BranchTree({ branches, currentBranch, branchStatus }) {
